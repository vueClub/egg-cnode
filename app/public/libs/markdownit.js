/* ! markdown-it 3.0.3 https://github.com//markdown-it/markdown-it @license MIT */!function(e) { if (typeof exports === "object" && typeof module !== "undefined")module.exports = e(); else if (typeof define === "function" && define.amd)define([], e); else { let f; typeof window !== "undefined" ? f = window : typeof global !== "undefined" ? f = global : typeof self !== "undefined" && (f = self), f.markdownit = e(); } }(function() {
  let define,
    ...
    const attr_value = replace(/(?:unquoted|single_quoted|double_quoted)/)
    ('unquoted', unquoted)
    ('single_quoted', single_quoted)
    ('double_quoted', double_quoted)
    ();

    const attribute = replace(/(?:\s+attr_name(?:\s*=\s*attr_value)?)/)
    ('attr_name', attr_name)
    ('attr_value', attr_value)
    ();

    const open_tag = replace(/<[A-Za-z][A-Za-z0-9\-]*attribute*\s*\/?>/)
    ('attribute', attribute)
    ();
    ...
    const HTML_TAG_RE = replace(/^(?:open_tag|close_tag|comment|processing|declaration|cdata)/)
    ('open_tag', open_tag)
    ('close_tag', close_tag)
    ('comment', comment)
    ...
    const SURRORATE_TEST_RE = /[\uD800-\uDFFF]/;
    const SURRORATE_SEARCH_RE = /[\uD800-\uDFFF]/g;
    ...
    function normalizeLink(url) {
      let normalized = replaceEntities(url);
    ...
    const BMP_PUNCT_RE = /[\x21-\x23\x25-\x2A\x2C-\x2F\x3A\x3B\x3F\x40\x5B-\x5D\x5F\x7B\x7D\xA1\xA7\xAB\xB6\xB7\xBB\xBF\u037E\u0387\u055A-\u055F\u0589\u058A\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0609\u060A\u060C\u060D\u061B\u061E\u061F\u066A-\u066D\u06D4\u0700-\u070D\u07F7-\u07F9\u0830-\u083E\u085E\u0964\u0965\u0970\u0AF0\u0DF4\u0E4F\u0E5A\u0E5B\u0F04-\u0F12\u0F14\u0F3A-\u0F3D\u0F85\u0FD0-\u0FD4\u0FD9\u0FDA\u104A-\u104F\u10FB\u1360-\u1368\u1400\u166D\u166E\u169B\u169C\u16EB-\u16ED\u1735\u1736\u17D4-\u17D6\u17D8-\u17DA\u1800-\u180A\u1944\u1945\u1A1E\u1A1F\u1AA0-\u1AA6\u1AA8-\u1AAD\u1B5A-\u1B60\u1BFC-\u1BFF\u1C3B-\u1C3F\u1C7E\u1C7F\u1CC0-\u1CC7\u1CD3\u2010-\u2027\u2030-\u2043\u2045-\u2051\u2053-\u205E\u207D\u207E\u208D\u208E\u2308-\u230B\u2329\u232A\u2768-\u2775\u27C5\u27C6\u27E6-\u27EF\u2983-\u2998\u29D8-\u29DB\u29FC\u29FD\u2CF9-\u2CFC\u2CFE\u2CFF\u2D70\u2E00-\u2E2E\u2E30-\u2E42\u3001-\u3003\u3008-\u3011\u3014-\u301F\u3030\u303D\u30A0\u30FB\uA4FE\uA4FF\uA60D-\uA60F\uA673\uA67E\uA6F2-\uA6F7\uA874-\uA877\uA8CE\uA8CF\uA8F8-\uA8FA\uA92E\uA92F\uA95F\uA9C1-\uA9CD\uA9DE\uA9DF\uAA5C-\uAA5F\uAADE\uAADF\uAAF0\uAAF1\uABEB\uFD3E\uFD3F\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE61\uFE63\uFE68\uFE6A\uFE6B\uFF01-\uFF03\uFF05-\uFF0A\uFF0C-\uFF0F\uFF1A\uFF1B\uFF1F\uFF20\uFF3B-\uFF3D\uFF3F\uFF5B\uFF5D\uFF5F-\uFF65]/;
    ...
    const normalizeLink = require('../common/utils').normalizeLink;
    const unescapeMd = require('../common/utils').unescapeMd;
 ...
 **/
    ...
    const Ruler = require('./ruler');
    const replaceEntities = require('./common/utils').replaceEntities;
    ...
    const BAD_PROTOCOLS = [ 'vbscript', 'javascript', 'file' ];
 ...
 **/
    ...
    rules.link_open = function(tokens, idx /* , options, env */) {
      ...
      const target = tokens[idx].target ? (' target="' + escapeHtml(tokens[idx].target) + '"') : '';
    ...
    rules.image = function(tokens, idx, options, env, self) {
      ...
      const title = tokens[idx].title ? (' title="' + escapeHtml(replaceEntities(tokens[idx].title)) + '"') : '';
      const alt = ' alt="' + self.renderInlineAsText(tokens[idx].tokens, options, env) + '"';
 ...
 **/
    ...
    const HTML_TAG_OPEN_RE = /^<([a-zA-Z]{1,15})[\s\/>]/;
    const HTML_TAG_CLOSE_RE = /^<\/([a-zA-Z]{1,15})[\s>]/;
    ...
    const normalizeReference = require('../helpers/normalize_reference');
    ...
    const url_schemas = require('../common/url_schemas');
    const normalizeLink = require('../common/utils').normalizeLink;


    /* eslint max-len:0*/
    const EMAIL_RE = /^<([a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)>/;
    const AUTOLINK_RE = /^<([a-zA-Z.\-]{1,25}):([^<>\x00-\x20]*)>/;
    ...
    StateInline.prototype.cacheSet = function(key, val) {
      for (let i = this.cache.length; i <= key; i++) {
        this.cache.push(0);
      }
   ...
   */
     ...
     */
        matcherRegex: (function() {
          let twitterRegex = /(^|[^\w])@(\w{1,15})/, // For matching a twitter handle. Ex: @gregory_jacobs
     ...
     */
        link(textOrHtml) {
          ...
          htmlParser.parse(textOrHtml, {
            ...
            processHtmlNode(tagText, tagName, isClosingTag) {
              if (tagName === 'a') {
            ...
            processTextNode(text) {
              if (anchorTagStackCount === 0) {
                ...
                const unescapedText = Autolinker.Util.splitAndCapture(text, htmlCharacterEntitiesRegex); // split at HTML entities, but include the HTML entities in the results array

                for (let i = 0, len = unescapedText.length; i < len; i++) {
                  let textToProcess = unescapedText[ i ],
     ...
     */
        getHtmlParser() {
          let htmlParser = this.htmlParser;
     ...
     */
        processTextNode(text) {
          const me = this; // for closure

          return text.replace(this.matcherRegex, function(matchStr, $1, $2, $3, $4, $5, $6, $7, $8) {
            const matchDescObj = me.processCandidateMatch(matchStr, $1, $2, $3, $4, $5, $6, $7, $8); // match description object
            ...
            const matchReturnVal = me.createMatchReturnVal(matchDescObj.match, matchDescObj.matchStr);
     ...
     */
        processCandidateMatch(
          matchStr, twitterMatch, twitterHandlePrefixWhitespaceChar, twitterHandle,
          emailAddressMatch, urlMatch, protocolUrlMatch, wwwProtocolRelativeMatch, tldProtocolRelativeMatch
        ) {
          let protocolRelativeMatch = wwwProtocolRelativeMatch || tldProtocolRelativeMatch,
        ...
        !this.matchValidator.isValidMatch(urlMatch, protocolUrlMatch, protocolRelativeMatch)
          ...
          if (emailAddressMatch) {
            ...
            match = new Autolinker.match.Twitter({ matchedText: matchStr, twitterHandle });

          } else { // url match
            // If it's a protocol-relative '//' match, remove the character before the '//' (which the matcherRegex needed
            // to match due to the lack of a negative look-behind in JavaScript regular expressions)
            if (protocolRelativeMatch) {
              const charBeforeMatch = protocolRelativeMatch.match(this.charBeforeProtocolRelMatchRegex)[ 1 ] || "";
     ...
     */
        matchHasUnbalancedClosingParen(matchStr) {
          const lastChar = matchStr.charAt(matchStr.length - 1);

          if (lastChar === ')') {
            let openParensMatch = matchStr.match(/\(/g),
     ...
     */
        createMatchReturnVal(match, matchStr) {
   ...
   */
     ...
     */
        extend(superclass, protoProps) {
          const superclassProto = superclass.prototype;
          ...
          const subclassProto = subclass.prototype = new F(); // set up prototype chain
     ...
     */
        ellipsis(str, truncateLen, ellipsisChars) {
     ...
     */
        splitAndCapture(str, splitRegex) {
   ...
   */
     ...
     */
        htmlRegex: (function() {
          let tagNameRegex = /[0-9a-zA-Z][0-9a-zA-Z:]*/,
     ...
     */
        parse(html, options) {
          ...
          let processHtmlNodeVisitor = options.processHtmlNode || function() {},
   ...
   */
     ...
     */
        isValidMatch(urlMatch, protocolUrlMatch, protocolRelativeMatch) {
          if (
     ...
     */
        isValidUriScheme(uriSchemeMatch) {
          const uriScheme = uriSchemeMatch.match(this.uriSchemeRegex)[ 0 ];
   ...
   */
     ...
     */
        createAttrs(matchType, anchorHref) {
          const attrs = {
            href: anchorHref, // we'll always have the `href` attribute
          };

          const cssClass = this.createCssClass(matchType);
          if (cssClass) {
